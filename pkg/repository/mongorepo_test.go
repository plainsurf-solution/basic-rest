...
// 	repo := NewMongoDBStudentRepository(client)
...
// 	// err = repo.UpdateStudent(&upstudent)
// 	// if err != nil {
...
// 	if student.Password == updatedStudent.Password {
// 		t.Fatalf("Updated password should be hashed, but it is not")
// 	}
